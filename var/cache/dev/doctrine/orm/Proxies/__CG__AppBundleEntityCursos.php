...
class Cursos extends \AppBundle\Entity\Cursos implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Cursos' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Cursos' . "\0" . 'titulo', '' . "\0" . 'AppBundle\\Entity\\Cursos' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\Cursos' . "\0" . 'precio'];
        }
